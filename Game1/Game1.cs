    ...
    public class Game1 : Game
    {
        ...
        public class CollisionDetector
        {
            ...
            public static bool Overlaps(IPhysicalObject2D a, IPhysicalObject2D b)
            {
                ...
                if (DetectCollision(upperLeftCorner, xAxisPoints, yAxisPoints)) return true;
                if (DetectCollision(upperRightCorner, xAxisPoints, yAxisPoints)) return true;
                if (DetectCollision(lowerLeftCorner, xAxisPoints, yAxisPoints)) return true;
                if (DetectCollision(lowerRightCorner, xAxisPoints, yAxisPoints)) return true;
                return false;
                
            }
            
            public static bool DetectCollision(PointF a, PointF xAxis, PointF yAxis)
            {
